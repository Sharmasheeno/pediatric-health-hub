...
export const ModuleComingSoon = ({ title, icon }) => (
  <div className="flex flex-col items-center justify-center min-h-[500px] bg-white rounded shadow-sm border border-slate-50 animate-fade-in mx-auto w-full">
    <div className="w-20 h-20 bg-[#f8f5ff] text-[#8244e0] rounded-2xl flex items-center justify-center mb-6 shadow-sm">
      <span className="text-4xl">{icon || '🚀'}</span>
    </div>
    <h2 className="text-2xl font-black text-slate-800 tracking-tight mb-3">{title}</h2>
    <p className="text-slate-400 font-medium max-w-sm text-center tracking-wide leading-relaxed">
